import { Bell, PlusCircle, LogOut, Sun, Moon, Github } from 'lucide-react';
...
export function Navbar() {
  ...
  return (
    <header className="bg-white dark:bg-gray-800 p-4 flex justify-between items-center border-b dark:border-gray-700">
